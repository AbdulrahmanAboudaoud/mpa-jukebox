    ...
    <div class="container">
        <div class="row">
            <div class="grid-2" style="margin-top:20px;">
                ...
                $total = DB::select("SELECT SUM(duration) FROM songs JOIN betweens ON songs.id=betweens.song_id && betweens.playlist_id = $playlist->id;");
                $sumstring = 'SUM(duration)';
                $array = json_decode(json_encode($total[0]), true);
                $arraySum = $array[$sumstring];
                $duration = strtotime($arraySum);
                ...
                <p class="duration text-warning "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-alarm" viewBox="0 0 16 16">
                  ...
                  </svg>  duration: <?php echo date('h:i', $duration)  ;?></p>
